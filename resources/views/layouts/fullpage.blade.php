...
<body>
    <div class="page-wrapper">
            ...
            <div class="header-top">
                <div class="container">
                    <div class="header-left">
                        <a href="tel:#"><i class="icon-phone"></i>{{ config('siteconfig.contacts.phone') }}</a>
                       &nbsp;|&nbsp;&nbsp; <a class="" href="mailto:{{ config('siteconfig.contacts.email.contact') }}"><i
                                ...
                                <ul class="menus">
                                    <li>
                                        <div class="header-dropdown">
                                            <a href="javascript:;">KES</a>
                                            <div class="header-menu">
                                                <ul>
                                                    <li><a href="javascript:;">KES</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="login"><a href="{{ url('logout') }}"><i class="icon-user"></i> Logout</a></li>
                                @else
                    ...
                    <div class="row">
                        <div class="col-auto col-lg-3 col-xl-3 col-xxl-2">
                            ...
                            <a href="index.html" class="logo">
                                <img src="{{url('assets/front/images/demos/demo-14/logo.png')}}" alt="Molla Logo" width="105"
                                    height="25">
                            </a>
                        </div>
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <div class="dropdown-cart-products">
                                                    <div class="product">
                                                        ...
                                                        <figure class="product-image-container">
                                                            <a href="product.html" class="product-image">
                                                                <img src="assets/front/images/products/cart/product-1.jpg"
                                                                    alt="product">
                                                            </a>
                                                        </figure>
                                                        <a href="#" class="btn-remove"
                                                    ...
                                                    <div class="product">
                                                        ...
                                                        <figure class="product-image-container">
                                                            <a href="product.html" class="product-image">
                                                                <img src="assets/front/images/products/cart/product-2.jpg"
                                                                    alt="product">
                                                            </a>
                                                        </figure>
                                                        <a href="#" class="btn-remove"
                                ...
                                <div class="dropdown-menu show">
                                    <nav class="side-nav">
                                        <ul class="menu-vertical sf-arrows">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="banner banner-overlay">
                                                                <a href="category.html" class="banner banner-menu">
                                                                    <img src="assets/front/images/demos/demo-13/menu/banner-1.jpg"
                                                                        alt="Banner">
                                                                </a>
                                                ...
                                                <div class="megamenu">
                                                    <div class="row no-gutters">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="banner banner-overlay">
                                                                <a href="category.html" class="banner banner-menu">
                                                                    <img src="assets/front/images/demos/demo-13/menu/banner-2.jpg"
                                                                        alt="Banner">
                                                                </a>
                                                            </div><!-- End .banner banner-overlay -->
                                                        </div><!-- End .col-md-4 -->
                                                    ...
                                                    <div class="menu-col">
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li><a href="#">Pans, Griddles & Woks</a>
                                                                    </li>
                                                                    <li><a href="#">Pots</a></li>
                                                                    <li><a href="#">Skillets & Grill Pans</a>
                                                                    </li>
                                                        ...
                                                        <div class="row menu-banners">
                                                            <div class="col-md-4">
                                                                <div class="banner">
                                                                    <a href="#">
                                                                        <img src="assets/front/images/demos/demo-13/menu/1.jpg"
                                                                            alt="image">
                                                                    </a>
                                                                </div><!-- End .banner -->
                                                            </div><!-- End .col-md-4 -->
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="banner">
                                                                    <a href="#">
                                                                        <img src="assets/front/images/demos/demo-13/menu/2.jpg"
                                                                            alt="image">
                                                                    </a>
                                                                </div><!-- End .banner -->
                                                            </div><!-- End .col-md-4 -->
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="banner">
                                                                    <a href="#">
                                                                        <img src="assets/front/images/demos/demo-13/menu/3.jpg"
                                                                            alt="image">
                                                                    </a>
                                                                </div><!-- End .banner -->
                                                            </div><!-- End .col-md-4 -->
                                                ...
                                                <div class="megamenu">
                                                    <div class="row no-gutters">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="banner banner-overlay">
                                                                <a href="category.html" class="banner banner-menu">
                                                                    <img src="assets/front/images/demos/demo-13/menu/banner-3.jpg"
                                                                        alt="Banner">
                                                                </a>
                                                            </div><!-- End .banner banner-overlay -->
                                                        </div><!-- End .col-md-4 -->
                                                    ...
                                                    <div class="menu-col menu-brands">
                                                        <div class="row">
                                                            <div class="col-lg-2">
                                                                <a href="#" class="brand">
                                                                    <img src="assets/front/images/brands/1.png"
                                                                        alt="Brand Name">
                                                                </a>
                                                            </div><!-- End .col-lg-2 -->
                                                            ...
                                                            <div class="col-lg-2">
                                                                <a href="#" class="brand">
                                                                    <img src="assets/front/images/brands/2.png"
                                                                        alt="Brand Name">
                                                                </a>
                                                            </div><!-- End .col-lg-2 -->
                                                            ...
                                                            <div class="col-lg-2">
                                                                <a href="#" class="brand">
                                                                    <img src="assets/front/images/brands/3.png"
                                                                        alt="Brand Name">
                                                                </a>
                                                            </div><!-- End .col-lg-2 -->
                                                            ...
                                                            <div class="col-lg-2">
                                                                <a href="#" class="brand">
                                                                    <img src="assets/front/images/brands/4.png"
                                                                        alt="Brand Name">
                                                                </a>
                                                            </div><!-- End .col-lg-2 -->
                                                            ...
                                                            <div class="col-lg-2">
                                                                <a href="#" class="brand">
                                                                    <img src="assets/front/images/brands/5.png"
                                                                        alt="Brand Name">
                                                                </a>
                                                            </div><!-- End .col-lg-2 -->
                                                            ...
                                                            <div class="col-lg-2">
                                                                <a href="#" class="brand">
                                                                    <img src="assets/front/images/brands/6.png"
                                                                        alt="Brand Name">
                                                                </a>
                                                            </div><!-- End .col-lg-2 -->
                                                        </div><!-- End .row -->
                                            ...
                                            <li><a href="#"><i class="icon-heartbeat"></i>Healthy & Beauty</a>
                                            </li>
                                            <li><a href="#"><i class="icon-shoe-prints"></i>Shoes & Boots</a>
                                            </li>
                                            <li><a href="#"><i class="icon-map-signs"></i>Travel & Outdoor</a>
                                            </li>
                                            <li><a href="#"><i class="icon-mobile-alt"></i>Smart Phones</a></li>
                                            <li><a href="#"><i class="icon-tv"></i>TV & Audio</a></li>
                                            <li><a href="#"><i class="icon-shopping-bag"></i>Backpack & Bag</a>
                                            </li>
                                            <li><a href="#"><i class="icon-music"></i>Musical Instruments</a>
                                            </li>
                                            ...
                                            <div class="menu-col">
                                                ...
                                                <div class="demo-list">
                                                    <div class="demo-item">
                                                        <a href="index-1.html">
                                                            <span class="demo-bg"
                                                                style="background-image: url(assets/front/images/menu/demos/1.jpg);"></span>
                                                    ...
                                                    <div class="demo-item">
                                                        <a href="index-2.html">
                                                            <span class="demo-bg"
                                                                style="background-image: url(assets/front/images/menu/demos/2.jpg);"></span>
                                                    ...
                                                    <div class="demo-item">
                                                        <a href="index-3.html">
                                                            <span class="demo-bg"
                                                                style="background-image: url(assets/front/images/menu/demos/3.jpg);"></span>
                                                    ...
                                                    <div class="demo-item">
                                                        <a href="index-4.html">
                                                            <span class="demo-bg"
                                                                style="background-image: url(assets/front/images/menu/demos/4.jpg);"></span>
                                                    ...
                                                    <div class="demo-item">
                                                        <a href="index-5.html">
                                                            <span class="demo-bg"
                                                                style="background-image: url(assets/front/images/menu/demos/5.jpg);"></span>
                                                    ...
                                                    <div class="demo-item">
                                                        <a href="index-6.html">
                                                            <span class="demo-bg"
                                                                style="background-image: url(assets/front/images/menu/demos/6.jpg);"></span>
                                                    ...
                                                    <div class="demo-item">
                                                        <a href="index-7.html">
                                                            <span class="demo-bg"
                                                                style="background-image: url(assets/front/images/menu/demos/7.jpg);"></span>
                                                    ...
                                                    <div class="demo-item">
                                                        <a href="index-8.html">
                                                            <span class="demo-bg"
                                                                style="background-image: url(assets/front/images/menu/demos/8.jpg);"></span>
                                                    ...
                                                    <div class="demo-item">
                                                        <a href="index-9.html">
                                                            <span class="demo-bg"
                                                                style="background-image: url(assets/front/images/menu/demos/9.jpg);"></span>
                                                    ...
                                                    <div class="demo-item">
                                                        <a href="index-10.html">
                                                            <span class="demo-bg"
                                                                style="background-image: url(assets/front/images/menu/demos/10.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-11.html">
                                                            <span class="demo-bg"
                                                                style="background-image: url(assets/front/images/menu/demos/11.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-12.html">
                                                            <span class="demo-bg"
                                                                style="background-image: url(assets/front/images/menu/demos/12.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-13.html">
                                                            <span class="demo-bg"
                                                                style="background-image: url(assets/front/images/menu/demos/13.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-14.html">
                                                            <span class="demo-bg"
                                                                style="background-image: url(assets/front/images/menu/demos/14.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-15.html">
                                                            <span class="demo-bg"
                                                                style="background-image: url(assets/front/images/menu/demos/15.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-16.html">
                                                            <span class="demo-bg"
                                                                style="background-image: url(assets/front/images/menu/demos/16.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-17.html">
                                                            <span class="demo-bg"
                                                                style="background-image: url(assets/front/images/menu/demos/17.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-18.html">
                                                            <span class="demo-bg"
                                                                style="background-image: url(assets/front/images/menu/demos/18.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-19.html">
                                                            <span class="demo-bg"
                                                                style="background-image: url(assets/front/images/menu/demos/19.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-20.html">
                                                            <span class="demo-bg"
                                                                style="background-image: url(assets/front/images/menu/demos/20.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-21.html">
                                                            <span class="demo-bg"
                                                                style="background-image: url(assets/front/images/menu/demos/21.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-22.html">
                                                            <span class="demo-bg"
                                                                style="background-image: url(assets/front/images/menu/demos/22.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-23.html">
                                                            <span class="demo-bg"
                                                                style="background-image: url(assets/front/images/menu/demos/23.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-24.html">
                                                            <span class="demo-bg"
                                                                style="background-image: url(assets/front/images/menu/demos/24.jpg);"></span>
                                        ...
                                        <div class="megamenu megamenu-md">
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="banner banner-overlay">
                                                        <a href="category.html" class="banner banner-menu">
                                                            <img src="assets/front/images/menu/banner-1.jpg"
                                                                alt="Banner">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="banner banner-overlay">
                                                        <a href="category.html">
                                                            <img src="assets/front/images/menu/banner-2.jpg"
                                                                alt="Banner">
        ...
        <footer class="footer">
            <div class="cta cta-horizontal cta-horizontal-box bg-dark bg-image"
                style="background-image: url('assets/front/images/demos/demo-14/bg-1.jpg');">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-4">
                            <div class="widget widget-about">
                                <img src="assets/front/images/demos/demo-14/logo-footer.png" class="footer-logo"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-8">
                                            ...
                                            <figure class="footer-payments">
                                                <img src="assets/front/images/payments.png" alt="Payment methods"
                                                    width="272" height="20">
                ...
                <div class="row no-gutters bg-white newsletter-popup-content">
                    <div class="col-xl-3-5col col-lg-7 banner-content-wrap">
                        <div class="banner-content text-center">
                            <img src="assets/front/images/popup/newsletter/logo.png" class="logo" alt="logo"
                                width="60" height="15">
                    ...
                    <div class="col-xl-2-5col col-lg-5 ">
                        <img src="assets/front/images/popup/newsletter/img-1.jpg" class="newsletter-img"
                            alt="newsletter">
                    </div>
                </div>
            </div>
    ...
    <script src="{{ url('assets/front/js/demos/demo-14.js') }}"></script>
</body>
