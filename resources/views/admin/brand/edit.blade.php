            ...
            <div class="col-md-12">
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">Edit brand - {{ ucfirst($page_title) }}</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="meta_title"
                                            ...
                                            value="{{ old('meta_title', $brand->meta_title) }}" id=""
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="meta_description" id="" cols="20" rows="3" placeholder="Enter meta description"
                                            class="form-control {{ $errors->has('meta_description') ? ' is-invalid' : '' }}">{{ old('meta_description', $brand->meta_description) }}</textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="meta_keywords"
                                            ...
                                            value="{{ old('meta_keywords', $brand->meta_keywords) }}" id=""
