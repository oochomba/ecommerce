            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('admin/shippingcharge/list') }}">Shipping Charge List</a></li>
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-info">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{ url('admin/shippingcharge/add') }}" method="post">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        <label for="name">Shipping Charge Name <span class="text text-danger">*</span></label>
