            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('admin/sub_category/list') }}">Sub Categories</a></li>
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-info">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{ url('admin/sub_category/add') }}" method="post">
                        <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            @foreach ($categories as $category)
                                                ...
                                                @endphp
                                                <option {{ (old('category_id') == $newObject->id) ? 'selected' : '' }} value="{{ old('category_id', $newObject->id) }}">
